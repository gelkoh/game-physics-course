...
public class Core : Game
{
    ...
    /// <summary>
    /// List of all CharacterControllers that handle player input in the Update-Function.
    /// </summary>
    public static readonly List<CharacterController> Controllers = [];
    /// <summary>
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        {
            SpriteBatch.Draw(s.Texture, s.GameObject.Position, null, s.Color, s.GameObject.Rotation, s.Offset, 1.0f, SpriteEffects.None, 0.0f);
        }
